...
## **9. Работы с сканером уязвимостей `OpenVAS`:**
### **9.1 Установка докера для успешной установки `OpenVAS` с его помощью:**
![image](Screenshots/34.png)
### **9.2 Пул докер файлов `OpenVAS`:**
![image](Screenshots/35.png)
### **9.3 Запуск web-интерфейса `OpenVAS`:**
![image](Screenshots/36.png)
![image](Screenshots/37.png)
### **9.4 Обновление утилит `OpenVAS` для возможности сканирования:**
![image](Screenshots/38.png)
### **9.5 Создание задания на сканирование Клиентской ВМ с помощью `OpenVAS`:**
![image](Screenshots/39.png)
### **9.6 Запуск задания на сканирование Клиентской ВМ с помощью `OpenVAS`:**
![image](Screenshots/40.png)
### **9.6 Результат выполнения задания на сканирование Клиентской ВМ с помощью `OpenVAS`:**
![image](Screenshots/41.png)
В Wazuh отобразились результаты проведенного сканирования
