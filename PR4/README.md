...
### **2.1 Импортируем логи lab2:**
![image](Screenshots/17.png)
### **2.2 Переключаемся на нужные логи в WEB-интерфейсе:**
![image](Screenshots/18.png)
### **2.3 Стартовая страница пустая, перейдем в вкладку DNS:**
![image](Screenshots/19.png)
![image](Screenshots/20.png)
### **2.4 Выберем параметр subdomain treshold и отобразим все обращения к поддоменам:**
...
### **3.1 Импортируем логи lab3:**
![image](Screenshots/22.png)
### **3.2 Переключаемся на нужные логи в WEB-интерфейсе:**
![image](Screenshots/23.png)
### **3.3 Главная страница и переход в beacons web**
![image](Screenshots/24.png)
![image](Screenshots/25.png)
### **3.4 Посмотрим каждый из 4 адресов:**
#### **3.4.1 Информация о первом адресе:**
![image](Screenshots/26.png)

Адрес связан с microsoft, малое количество связей - безопасен
#### **3.4.2 Информация о втором адресе:**
![image](Screenshots/27.png)

Адрес явно вредоносен из-за количества связей и очень стабильного графика подключений ко времени
#### **3.4.3 Информация о третьем адресе:**
![image](Screenshots/28.png)

Аналогично первому адресу - безопасен
#### **3.4.4 Информация о четвертом адресе:**
![image](Screenshots/29.png)

Аналогично первому адресу - безопасен

### **3.5 Перейдем к модулю long connections и проверим найденные там адреса:**
![image](Screenshots/30.png)
#### **3.5.1 Просмотр первого адреса**
![image](Screenshots/31.png)

Адрес вредоносен, об этом говорят два репорта от вендера abuseipdb.com
#### **3.5.2 Просмотр второго адреса**
![image](Screenshots/32.png)

Адрес безопасен, так как не был отмечен как вредоносный вендером virustotal.com
### **Вывод по lab3:**
**Под подозрение о вредоносности попадает первый адрес. Странное название хоста, явно сгенерированное рандомно и говорящее о временном домене. Также сервис для проверки отметил два раза его вредоносность. Также о вредоносности может говорить количество детекций соединений на один адрес**
